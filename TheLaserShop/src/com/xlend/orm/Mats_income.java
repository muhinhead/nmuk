...
public class Mats_income extends DbObject  {
    ...
    public Mats_income(Connection connection) {
        ...
        setColumnNames(new String[]{"incomeID", "dtTime", "incoming", "restAfterIncome", "itemID"});
    }

    public Mats_income(Connection connection, Integer incomeID, Timestamp dtTime, Integer incoming, Integer restAfterIncome, Integer itemID) {
        super(connection, "mats_income", "incomeID");
...
//        }
    ...
    public DbObject loadOnId(int id) throws SQLException, ForeignKeyViolationException {
        ...
        ResultSet rs = null;
        String stmt = "SELECT incomeID,dtTime,incoming,restAfterIncome,itemID FROM mats.income WHERE incomeID=" + id;
        try {
    ...
    protected void insert() throws SQLException, ForeignKeyViolationException {
         ...
         PreparedStatement ps = null;
         String stmt =
                "INSERT INTO mats.income ("+(getIncomeID().intValue()!=0?"incomeID,":"")+"dtTime,incoming,restAfterIncome,itemID) values("+(getIncomeID().intValue()!=0?"?,":"")+"?,?,?,?)";
         try {
             ps = getConnection().prepareStatement(stmt);
             int n = 0;
    ...
    public void save() throws SQLException, ForeignKeyViolationException {
        if (isNew()) {
            ...
            String stmt =
                    "UPDATE mats.income " +
                    "SET dtTime = ?, incoming = ?, restAfterIncome = ?, itemID = ?" + 
    ...
    public static DbObject[] load(Connection con,String whereCondition,String orderCondition) throws SQLException {
        ...
        PreparedStatement ps = null;
        ResultSet rs = null;
        String stmt = "SELECT incomeID,dtTime,incoming,restAfterIncome,itemID FROM mats.income " +
        ...
        try {
            ...
            while (rs.next()) {
                DbObject dbObj;
                lst.add(dbObj=new Mats_income(con,new Integer(rs.getInt(1)),rs.getTimestamp(2),new Integer(rs.getInt(3)),new Integer(rs.getInt(4)),new Integer(rs.getInt(5))));
                dbObj.setNew(false);
            }
        } finally {
            try {
