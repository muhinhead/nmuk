...
//        }
    ...
    public DbObject loadOnId(int id) throws SQLException, ForeignKeyViolationException {
        ...
        ResultSet rs = null;
        String stmt = "SELECT incomeID,dtTime,incoming,restAfterIncome,itemID,userID FROM mats_income WHERE incomeID=" + id;
        try {
    ...
    protected void insert() throws SQLException, ForeignKeyViolationException {
         ...
         PreparedStatement ps = null;
         String stmt =
                "INSERT INTO mats_income ("+(getIncomeID().intValue()!=0?"incomeID,":"")+"dtTime,incoming,restAfterIncome,itemID,userID) values("+(getIncomeID().intValue()!=0?"?,":"")+"?,?,?,?,?)";
         try {
             ps = getConnection().prepareStatement(stmt);
             int n = 0;
         ...
         ResultSet rs = null;
         if (getIncomeID().intValue()==0) {
             stmt = "SELECT max(incomeID) FROM mats_income";
             try {
                 ps = getConnection().prepareStatement(stmt);
                 rs = ps.executeQuery();
                 if (rs.next()) {
    ...
    public static DbObject[] load(Connection con,String whereCondition,String orderCondition) throws SQLException {
        ...
        PreparedStatement ps = null;
        ResultSet rs = null;
        String stmt = "SELECT incomeID,dtTime,incoming,restAfterIncome,itemID,userID FROM mats_income " +
    ...
    public static boolean exists(Connection con, String whereCondition) throws SQLException {
        ...
        PreparedStatement ps = null;
        ResultSet rs = null;
        String stmt = "SELECT incomeID FROM mats_income " +
                ((whereCondition != null && whereCondition.length() > 0) ?
                "WHERE " + whereCondition : "");
        try {
            ps = con.prepareStatement(stmt);
