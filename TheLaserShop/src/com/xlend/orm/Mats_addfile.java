...
//        }
    ...
    public DbObject loadOnId(int id) throws SQLException, ForeignKeyViolationException {
        ...
        ResultSet rs = null;
        String stmt = "SELECT addfileID,name,filetype,filebody,description,userID,itemID,incomeID FROM mats.addfile WHERE addfileID=" + id;
        try {
    ...
    protected void insert() throws SQLException, ForeignKeyViolationException {
         ...
         PreparedStatement ps = null;
         String stmt =
                "INSERT INTO mats.addfile ("+(getAddfileID().intValue()!=0?"addfileID,":"")+"name,filetype,filebody,description,userID,itemID,incomeID) values("+(getAddfileID().intValue()!=0?"?,":"")+"?,?,?,?,?,?,?)";
         try {
             ps = getConnection().prepareStatement(stmt);
             int n = 0;
         ...
         ResultSet rs = null;
         if (getAddfileID().intValue()==0) {
             stmt = "SELECT max(addfileID) FROM mats.addfile";
             try {
                 ps = getConnection().prepareStatement(stmt);
                 rs = ps.executeQuery();
                 if (rs.next()) {
    ...
    public static DbObject[] load(Connection con,String whereCondition,String orderCondition) throws SQLException {
        ...
        PreparedStatement ps = null;
        ResultSet rs = null;
        String stmt = "SELECT addfileID,name,filetype,filebody,description,userID,itemID,incomeID FROM mats.addfile " +
    ...
    public static boolean exists(Connection con, String whereCondition) throws SQLException {
        ...
        PreparedStatement ps = null;
        ResultSet rs = null;
        String stmt = "SELECT addfileID FROM mats.addfile " +
                ((whereCondition != null && whereCondition.length() > 0) ?
                "WHERE " + whereCondition : "");
        try {
            ps = con.prepareStatement(stmt);
