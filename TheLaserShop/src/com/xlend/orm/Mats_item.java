...
//        }
    ...
    public DbObject loadOnId(int id) throws SQLException, ForeignKeyViolationException {
        ...
        ResultSet rs = null;
        String stmt = "SELECT itemID,invCode,name,colour,thickness,quantity,sheetSize,sheetCost,sheetMarkup,mattypeID FROM mats.item WHERE itemID=" + id;
        try {
    ...
    protected void insert() throws SQLException, ForeignKeyViolationException {
         ...
         PreparedStatement ps = null;
         String stmt =
                "INSERT INTO mats.item ("+(getItemID().intValue()!=0?"itemID,":"")+"invCode,name,colour,thickness,quantity,sheetSize,sheetCost,sheetMarkup,mattypeID) values("+(getItemID().intValue()!=0?"?,":"")+"?,?,?,?,?,?,?,?,?)";
         try {
             ps = getConnection().prepareStatement(stmt);
             int n = 0;
         ...
         ResultSet rs = null;
         if (getItemID().intValue()==0) {
             stmt = "SELECT max(itemID) FROM mats.item";
             try {
                 ps = getConnection().prepareStatement(stmt);
                 rs = ps.executeQuery();
                 if (rs.next()) {
    ...
    public static DbObject[] load(Connection con,String whereCondition,String orderCondition) throws SQLException {
        ...
        PreparedStatement ps = null;
        ResultSet rs = null;
        String stmt = "SELECT itemID,invCode,name,colour,thickness,quantity,sheetSize,sheetCost,sheetMarkup,mattypeID FROM mats.item " +
    ...
    public static boolean exists(Connection con, String whereCondition) throws SQLException {
        ...
        PreparedStatement ps = null;
        ResultSet rs = null;
        String stmt = "SELECT itemID FROM mats.item " +
                ((whereCondition != null && whereCondition.length() > 0) ?
                "WHERE " + whereCondition : "");
        try {
            ps = con.prepareStatement(stmt);
