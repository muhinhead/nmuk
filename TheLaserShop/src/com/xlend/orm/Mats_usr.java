...
//        }
    ...
    public DbObject loadOnId(int id) throws SQLException, ForeignKeyViolationException {
        ...
        ResultSet rs = null;
        String stmt = "SELECT userID,login,password,isAdmin,position,firstName,secondName,lastName FROM mats_usr WHERE userID=" + id;
        try {
    ...
    protected void insert() throws SQLException, ForeignKeyViolationException {
         ...
         PreparedStatement ps = null;
         String stmt =
                "INSERT INTO mats_usr ("+(getUserID().intValue()!=0?"userID,":"")+"login,password,isAdmin,position,firstName,secondName,lastName) values("+(getUserID().intValue()!=0?"?,":"")+"?,?,?,?,?,?,?)";
         try {
             ps = getConnection().prepareStatement(stmt);
             int n = 0;
         ...
         ResultSet rs = null;
         if (getUserID().intValue()==0) {
             stmt = "SELECT max(userID) FROM mats_usr";
             try {
                 ps = getConnection().prepareStatement(stmt);
                 rs = ps.executeQuery();
                 if (rs.next()) {
    ...
    public void delete() throws SQLException, ForeignKeyViolationException {
        if (Mats_addfile.exists(getConnection(),"userID = " + getUserID())) {
    ...
    public static DbObject[] load(Connection con,String whereCondition,String orderCondition) throws SQLException {
        ...
        PreparedStatement ps = null;
        ResultSet rs = null;
        String stmt = "SELECT userID,login,password,isAdmin,position,firstName,secondName,lastName FROM mats_usr " +
    ...
    public static boolean exists(Connection con, String whereCondition) throws SQLException {
        ...
        PreparedStatement ps = null;
        ResultSet rs = null;
        String stmt = "SELECT userID FROM mats_usr " +
                ((whereCondition != null && whereCondition.length() > 0) ?
                "WHERE " + whereCondition : "");
        try {
            ps = con.prepareStatement(stmt);
